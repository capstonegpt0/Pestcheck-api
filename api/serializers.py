...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'phone', 'first_name', 'last_name', 'role', 'is_verified', 'created_at']
...
class FarmSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Farm
        fields = ['id', 'name', 'lat', 'lng', 'size', 'crop_type', 'is_verified', 
                  'created_at', 'updated_at', 'user_id', 'user_name', 'infestation_count']
        read_only_fields = ['id', 'created_at', 'updated_at', 'user_id', 'user_name', 'is_verified']
    
    def get_infestation_count(self, obj):
        return obj.detections.filter(active=True).count()
...
class PestDetectionSerializer(serializers.ModelSerializer):
    ...
    pest = serializers.CharField(source='pest_name', read_only=True)  # Alias for frontend compatibility
    ...
    def to_representation(self, instance):
        ...
        # Add 'pest' field for frontend compatibility
        representation['pest'] = instance.pest_name or instance.pest_type
        # Ensure farm_id is always included
