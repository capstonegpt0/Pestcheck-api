...
class Farm(models.Model):
    ...
    is_verified = models.BooleanField(default=False)  # Admin can verify farms
    created_at = models.DateTimeField(auto_now_add=True)
...
class PestDetection(models.Model):
    ...
    admin_notes = models.TextField(blank=True)  # Admin can add notes
...
class PestInfo(models.Model):
    ...
    is_published = models.BooleanField(default=True)  # Admin can publish/unpublish
...
class Alert(models.Model):
    ...
    target_area = models.CharField(max_length=100, blank=True)  # e.g., "Magalang, Pampanga"
...
class UserActivity(models.Model):
    ...
    action = models.CharField(max_length=100)  # e.g., "created_farm", "detected_pest"
